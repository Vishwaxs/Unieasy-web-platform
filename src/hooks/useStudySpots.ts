...
const mockStudySpots: StudySpot[] = [
  {
    ...
    comment: "Best study spot on campus",
  },
  {
    id: "2",
    name: "Study Cafe",
    ...
    comment: "Great coffee while studying",
  },
  {
    id: "3",
    name: "Reading Room",
  ...
  },
  {
    ...
    comment: "Fresh air while studying",
  },
  {
    id: "6",
    name: "Department Lab",
...
async function fetchStudySpots(): Promise<StudySpot[]> {
  try {
    ...
    if (!places || places.length === 0) {
      console.warn(
        "[useStudySpots] No places returned, using fallback mock data",
      );
    ...
    console.warn(
      "[useStudySpots] Backend fetch failed, using fallback mock data:",
      err,
    );
    return mockStudySpots;
  }
