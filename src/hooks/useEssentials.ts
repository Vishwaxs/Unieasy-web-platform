...
const mockItems: EssentialItem[] = [
  {
    ...
    comment: "Modern equipment, student rates",
  },
  {
    id: "2",
    name: "Quick Laundry",
    ...
    comment: "24/7 self-service laundry",
  },
  {
    id: "3",
    ...
    comment: "Cheap prints for students",
  },
  {
    id: "4",
    ...
    comment: "24/7 emergency response",
  },
  {
    id: "5",
    name: "Health Center",
    ...
    comment: "Free consultations for students",
  },
  {
    id: "6",
    ...
    comment: "Safe space and support",
  },
  {
    id: "7",
    name: "Tech Store",
    ...
    comment: "15% off with student ID",
  },
  {
    id: "8",
    name: "Movie Theater",
    ...
    comment: "Student Tuesday specials",
  },
  {
    id: "9",
    name: "Bookstore",
  ...
  },
  {
    ...
    comment: "Weekly events and meetups",
  },
  {
    id: "11",
    ...
    comment: "Festivals and celebrations",
  },
  {
    id: "12",
    name: "Sports Club",
    ...
    comment: "Join teams and tournaments",
  },
  {
    id: "13",
    name: "Career Center",
    ...
    comment: "Resume help and job fairs",
  },
  {
    id: "14",
    name: "Skill Workshop",
...
async function fetchEssentials(): Promise<EssentialItem[]> {
  try {
    ...
    if (allPlaces.length === 0) {
      console.warn(
        "[useEssentials] No places returned, using fallback mock data",
      );
      return mockItems;
    }
    ...
    console.warn(
      "[useEssentials] Backend fetch failed, using fallback mock data:",
      err,
    );
    return mockItems;
  }
