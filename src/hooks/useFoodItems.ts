...
const mockFoodItems: FoodItem[] = [
  {
    ...
    comment: "Best cheese pizza in town!",
  },
  {
    id: "2",
    name: "Butter Chicken",
  ...
  },
  {
    ...
    comment: "Complete meal experience",
  },
  {
    id: "8",
    name: "Egg Fried Rice",
  ...
  },
  {
    ...
    comment: "Authentic Punjabi flavors",
  },
  {
    id: "10",
...
async function fetchFoodItems(): Promise<FoodItem[]> {
  try {
    ...
    if (!places || places.length === 0) {
      console.warn(
        "[useFoodItems] No places returned, using fallback mock data",
      );
    ...
    console.warn(
      "[useFoodItems] Backend fetch failed, using fallback mock data:",
      err,
    );
    return mockFoodItems;
  }
