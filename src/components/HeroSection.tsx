...
const HeroSection = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden -mt-14 hero-home-section">
      {/* Animated Background */}
      ...
      {/* Content */}
      <div className="relative z-10 container mx-auto px-4 md:px-6 text-center pt-14 hero-home-content">
        <div className="relative mx-auto max-w-4xl px-4 py-8 md:px-8 md:py-10 hero-panel-in hero-home-panel">
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-foreground mb-4 md:mb-6 animate-fade-up hero-home-title">
            Discover Your Campus, <span className="text-primary">Your Way</span>
          </h1>
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-muted-foreground mb-8 md:mb-10 max-w-3xl mx-auto animate-fade-up stagger-1 hero-home-subtitle">
            Find the best food spots, accommodation, and hidden gems around your
            university
          </p>
          ...
          <div className="max-w-2xl mx-auto animate-fade-up stagger-2">
            ...
            >
              ...
              <Button
                size="lg"
                className="rounded-xl w-full sm:w-auto hero-search-pulse"
                type="submit"
              >
                Search
              </Button>
