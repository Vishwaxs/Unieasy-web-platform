...
type BlockFilter = "all" | "Block 1" | "Block 2" | "Block 4" | "Central Block";
...
const mockShops: CampusShop[] = [
  { id: "1", name: "Campus Mart", block: "Block 1", floor: "Ground Floor", category: "Essentials", image: "https://images.unsplash.com/photo-1506617420156-8e4536971650?w=400", comment: "Snacks, stationery, daily needs" },
  { id: "2", name: "Print Hub", block: "Central Block", floor: "1st Floor", category: "Services", image: "https://images.unsplash.com/photo-1498050108023-c5249f4df085?w=400", comment: "Printouts and bindings" },
  { id: "3", name: "Cafe Corner", block: "Block 4", floor: "2nd Floor", category: "Food", image: "https://images.unsplash.com/photo-1501339847302-ac426a4a7cbb?w=400", comment: "Quick bites between classes" },
  { id: "4", name: "Student Store", block: "Block 2", floor: "Ground Floor", category: "Merch", image: "https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=400", comment: "University merch and gifts" },
];
          ...
          <div className="flex flex-wrap items-center justify-between gap-4 mb-6">
            ...
            <div className="hidden md:flex items-center gap-3 w-full">
              <div className="flex flex-wrap gap-2 items-center">
                {(["all", "Block 1", "Block 2", "Block 4", "Central Block"] as BlockFilter[]).map((f) => (
