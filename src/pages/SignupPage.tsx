            ...
            <SignUp
              ...
              appearance={{
                elements: {
                  ...
                  formFieldInputShowPasswordIcon: "dark:!text-muted-foreground",
                  formFieldInputShowPasswordButton: "dark:!text-muted-foreground hover:!text-foreground",
                  ...
                  alternativeMethodsBlockButton: "text-foreground border-border hover:bg-muted",
                },
              }}
            />
          </div>
